...
latex.DrawLatex(3.85,.42,"N_{shots} = 512")
latex = TLatex()
latex.SetTextSize(0.045)
latex.SetTextFont(42)
latex.DrawLatex(3.85,.32,"error mitigation applied")


leg = TLegend(0.45, 0.6, 0.9, 0.9)

leg.AddEntry(ideal_sim_hist, "Ideal Simulation", "f")
leg.AddEntry(fake_nairobi_hist, "Fake ibm_nairobi", "f")
