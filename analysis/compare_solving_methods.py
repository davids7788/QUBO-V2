...
Teff_fully_mis_bit_qaoa_ideal_qasm_sim = TEfficiency(fully_mismatched_xplets_qaoa_ideal_qasm_sim, reco_xplets_qaoa_ideal_qasm_sim)
...
h_frame.GetXaxis().SetRangeUser(-0.1, 0.5)
h_frame.Draw()
...
# Teff_bit_qaoa_ideal_qasm_sim.SetMarkerStyle(22)
# Teff_bit_qaoa_ideal_qasm_sim.SetMarkerColorAlpha(3, 0.85)
# Teff_bit_qaoa_ideal_qasm_sim.SetMarkerSize(1.95)
# Teff_bit_qaoa_ideal_qasm_sim.Draw("PSAME")
...
Teff_fully_mis_vqe_ideal_qasm_sim_TwoLocal.SetMarkerStyle(26)
...
# Teff_vqe_ideal_qasm_sim_HamiltonianDriven.SetMarkerStyle(33)
# Teff_vqe_ideal_qasm_sim_HamiltonianDriven.SetMarkerColorAlpha(6, 0.85)
# Teff_vqe_ideal_qasm_sim_HamiltonianDriven.SetMarkerSize(1.95)
# Teff_vqe_ideal_qasm_sim_HamiltonianDriven.Draw("PSAME")
...
leg = TLegend(0.22, 0.25, 0.57, 0.55)
leg.SetNColumns(2)
...
canv.SaveAs(f"{gen_out}/1Dxplet_efficiency_comparison_xi_{xi}.pdf")