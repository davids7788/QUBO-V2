...
gen_xplets = TH1F('gen xplets', 'energy', 50, 1, 11)

matched_xplets_bit_flip = TH1F('matched xplets bit flip', 'energy', 50, 1, 11)
matched_xplets_eigensolver = TH1F('matched xplets Numpy Eigensolver', 'energy', 50, 1, 11)
matched_xplets_qaoa_ideal_qasm_sim = TH1F('matched xplets QAOA Ideal Sim', 'energy', 50, 1, 11)
matched_xplets_vqe_ideal_qasm_sim_TwoLocal = TH1F('matched xplets VQE Ideal Sim TwoLocal', 'energy', 50, 1, 11)
# matched_xplets_vqe_ideal_qasm_sim_HamiltonianDriven = TH1F('matched xplets VQE Ideal Sim HamiltonianDriven', 
#                                                            'energy', 50, 1, 11)

fully_mismatched_xplets_bit_flip = TH1F('fully mismatched bit flip', 'energy', 50, 1, 11)
fully_mismatched_xplets_eigensolver = TH1F('fully mismatched Numpy Eigensolver', 'energy', 50, 1, 11)
fully_mismatched_xplets_qaoa_ideal_qasm_sim = TH1F('fully mismatched QAOA Ideal Sim', 'energy', 50, 1, 11)
fully_mismatched_xplets_vqe_ideal_qasm_sim_TwoLocal = TH1F('fully mismatched VQE Ideal Sim TwoLocal', 'energy', 50, 1, 11)
# fully_mismatched_xplets_vqe_ideal_qasm_sim_HamiltonianDriven = TH1F('fully mismatched VQE Ideal Sim HamiltonianDriven', 
#                                                                     'energy', 50, 1, 11)

reco_xplets_bit_flip = TH1F('reco xplets bit flip', 'energy', 50, 1, 11)
reco_xplets_eigensolver = TH1F('reco xplets Numpy Eigensolver', 'energy', 50, 1, 11)
reco_xplets_qaoa_ideal_qasm_sim = TH1F('reco xplets QAOA Ideal Sim', 'energy', 50, 1, 11)
reco_xplets_vqe_ideal_qasm_sim_TwoLocal = TH1F('reco xplets VQE Ideal Sim TwoLocal', 'energy', 50, 1, 11)
# reco_xplets_vqe_ideal_qasm_sim_HamiltonianDriven = TH1F('reco xplets VQE Ideal Sim HamiltonianDriven', 'energy', 50, 1, 11)
...
for m_x in matched_eigensolver:
    matched_xplets_eigensolver.Fill(m_x.energy[0] / 1000)
for m_x in matched_qaoa_ideal_qasm_sim:
    matched_xplets_qaoa_ideal_qasm_sim.Fill(m_x.energy[0] / 1000)
...
#     matched_xplets_vqe_ideal_qasm_sim_HamiltonianDriven.Fill(m_x.energy[0] / 1000)
...
for m_x in fully_mismatched_eigensolver:
    fully_mismatched_xplets_eigensolver.Fill(m_x.energy[0] / 1000)
for m_x in fully_mismatched_qaoa_ideal_qasm_sim:
    fully_mismatched_xplets_qaoa_ideal_qasm_sim.Fill(m_x.energy[0] / 1000)
...
#     fully_mismatched_xplets_vqe_ideal_qasm_sim_HamiltonianDriven.Fill(m_x.energy[0] / 1000)
    
# reco_xplets
for r_x in reco_bit_flip:
    reco_xplets_bit_flip.Fill(r_x.energy[0] / 1000)
for r_x in reco_eigensolver:
    reco_xplets_eigensolver.Fill(r_x.energy[0] / 1000)
for r_x in reco_qaoa_ideal_qasm_sim:
    reco_xplets_qaoa_ideal_qasm_sim.Fill(r_x.energy[0] / 1000)
...
#     reco_xplets_vqe_ideal_qasm_sim_HamiltonianDriven.Fill(r_x.energy[0] / 1000)
...
h_frame.GetXaxis().SetRangeUser(0, 16500)
